...
def sendQR(png):
    ...
    cam = cv2.VideoCapture('http://192.168.1.52:8080/video')
    ...
    # Agregar texto arriba del rectángulo
        cv2.putText(frame, f"{nombre} - {texto}", (x, y - 10),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, color, 2)

# Aquí puedes mostrar el frame o retornarlo
    cv2.imshow("Puestos de Parqueo", frame)
    cv2.waitKey(0)
